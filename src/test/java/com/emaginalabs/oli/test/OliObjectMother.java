 ...
 */
package com.emaginalabs.oli.test;
...
import com.emaginalabs.oli.guard.CircuitBreakerTemplate;
 ...
 * @since 1.0
 */
public final class OliObjectMother {
	private static OliObjectMother mom = new OliObjectMother();
	...
	public static OliObjectMother instance() { return mom; }

	private OliObjectMother() {
		try {
			initGenericStuff();
